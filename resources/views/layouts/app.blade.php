...
<head>
    ...
    <style>
        ...
        /* Custom color mimic based on image */
...
<body class="bg-gray-50">
    ...
    <div class="flex h-screen overflow-hidden">
        <aside class="w-64 bg-sidebar text-white flex flex-col fixed inset-y-0 left-0 z-30 transition-transform duration-300 transform md:translate-x-0 md:relative">
            <div class="p-6 flex items-center gap-3">
                <div class="bg-white p-2 rounded-lg">
                    <svg class="w-6 h-6 text-purple-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
                </div>
                <div>
            ...
            <nav class="flex-1 px-4 space-y-2 mt-4">
                <a href="#" class="{{ request()->is('dashboard') ? 'bg-white text-purple-700' : 'text-purple-100 hover:bg-purple-600' }} flex items-center gap-3 px-4 py-3 rounded-lg transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                    <span class="font-medium">Dashboard</span>
                </a>

                <a href="#" class="{{ request()->is('kategori') ? 'bg-white text-purple-700' : 'text-purple-100 hover:bg-purple-600' }} flex items-center gap-3 px-4 py-3 rounded-lg transition-colors">
            ...
            <div class="p-4 mt-auto border-t border-purple-500">
                <div class="flex items-center gap-3 mb-4">
                    <div class="text-sm">
                        ...
                        <p class="text-purple-200 text-xs">Owner</p>
                    </div>
                </div>
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 h-full relative">
             <header class="bg-purple-600 h-40 absolute top-0 left-0 w-full z-0"></header>
